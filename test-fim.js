...
console.log('4:', html.includes('fim-title'));
...
console.log('5:', html.includes('fim-title'));

html = html.replace(/<div class="char-name">(.*?)<\/div>/g, '');
console.log('6:', html.includes('fim-title'));

html = html.replace(/AUDIO_PLACEHOLDER/g, '');
html = html.replace(/<span class="tag">Coment.*?rio<\/span>/gi, '');
console.log('7:', html.includes('fim-title'));

html = html.replace(/<!-- PARTE FINAL -->[\s\S]*?<section class="scene-section expanded" id="scene-final"[\s\S]*?<\/section>/, '');
console.log('8:', html.includes('fim-title'));
